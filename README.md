...
5. **plot.py:** Takes the bipartite market graph and creates a visualization of it, including all of its attributes. The output file for the graph is called `market_graph.gml`.
